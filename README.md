...
**Статус:** 🚧 Phase 3 In Progress (Frontend, Auth & Wizard)
...
*   **Auth**: Полноценная система авторизации (Google OAuth 2.0 + JWT).
...
*   **Wizard Flow**:
*   **Step 1**: Загрузка файлов (Drag & Drop) с предпросмотром и валидацией.
*   **Step 2**: Настройки генерации (Промпт, Соотношение сторон).
*   **Navbar**: Адаптивная навигация с состоянием авторизации и мобильным меню.
