        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 bg-gray-900 border border-purple-500/20 rounded-lg flex items-center justify-center hover:bg-purple-500/20 hover:border-purple-500 transition-colors">
